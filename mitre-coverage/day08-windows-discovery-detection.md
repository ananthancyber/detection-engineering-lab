...
The following SPL query was used to establish the initial baseline:
...
The current telemetry baseline returned:
...
This demonstrated that discovery-related activity was already common in the environment.
...
This analysis was important because it demonstrated that the environment contains substantial legitimate enumeration activity.
...
This demonstrates a practical detection engineering approach based on observed telemetry, process context, and controlled validation.
